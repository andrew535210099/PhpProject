    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <p><?php echo tutors_foto($r1['id']) ?></p>
                <td><?php echo $r1['nama'] ?></td>
                <td>
                    <a href="tutors_input.php?id=<?php echo $r1['id']?> ">
                    <span class="badge bg-warning text-dark">Edit</span>
                    <a href="tutors.php?op=delete&id=<?php echo $r1['id']?>" onclick="return confirm('Apakah yakin mau hapus?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1 ; $i<= $pages ; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="tutors.php?katakunci=<?php echo $katakunci ?> & cari= <?php echo $cari ?> & page= <?php echo $i?>"></a>
            </li>d
            <?php
        }
        ?>
